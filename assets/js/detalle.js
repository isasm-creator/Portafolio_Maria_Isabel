...
mostrarLugar();
// 4. Mostrar sección de pronóstico semanal
...
const estadisticasPronostico = () => {
  ...
  let promedioSemanal = Math.round(
...
minTempContainer.textContent = `${estadisticas.minimaSemanal}°C`;
maxTempContainer.textContent = `${estadisticas.maximaSemanal}°C`;
avTempContainer.textContent = `${estadisticas.promedioSemanal}°C`;
